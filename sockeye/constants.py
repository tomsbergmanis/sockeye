...
# loss
ALIGNMENT_CROSS_ENTROPY_LOSS = 'alignment-cross-entropy-loss'
...
DATA_KEY_ALIGNMENT = 'alignment'
DATA_KEYS = [DATA_KEY_SOURCE, DATA_KEY_TARGET, DATA_KEY_ALIGNMENT]
SHARD_NAME = "shard.%05d"
SHARD_SOURCE = SHARD_NAME + ".source"
SHARD_TARGET = SHARD_NAME + ".target"
SHARD_ALIGNMENT = SHARD_NAME + ".alignment"
DATA_INFO = "data.info"
